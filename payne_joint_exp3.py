...
nfs_flow = NSF_CL
flows = [nfs_flow(dim=dim, device=device, K=8, B=3, hidden_dim=256) for _ in range(30)] #things to change> maybe more is needed??!
...
np.savetxt('loss_hist_exp3.npy', loss_history)
