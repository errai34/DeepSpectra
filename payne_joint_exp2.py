...
nfs_flow = NSF_CL
flows = [nfs_flow(dim=dim, device=device, K=8, B=3, hidden_dim=128) for _ in range(30)] #things to change> maybe more is needed??!
...
np.savetxt('loss_hist_exp2.npy', loss_history)
